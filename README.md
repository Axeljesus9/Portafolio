# Portafolio
# ¡Hola! Soy Jesus Axel Avila Garcia 👋
...
*   **Sistemas del Sector Salud (Estadía Profesional):** Desarrollo del Sistema de Gestión Médica para la *Fundación AI-KOI*, optimizando agendas clínicas y flujos de atención para mejorar la experiencia del usuario.
*   **Investigación y Desarrollo (Estadía Profesional):** Colaboración de alto impacto en el *CIDTFA* (Centro de Investigación y Desarrollo de Tecnologías para la Defensa Nacional), enfocándome en soluciones lógicas, optimización de algoritmos y sistemas embebidos.
